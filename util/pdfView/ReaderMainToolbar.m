...
- (id)initWithFrame:(CGRect)frame document:(ReaderDocument *)object
{
	...
	if ((self = [super initWithFrame:frame]))
	{
		...
		[doneButton setBackgroundImage:[UIImage imageNamed:@"backImage.png"] forState:UIControlStateNormal];
...
{
    UILabel *theLabel = (UILabel*)[self viewWithTag:100];
