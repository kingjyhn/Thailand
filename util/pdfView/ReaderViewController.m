...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"mookBg.png"]];
    ...
    mainToolbar.backgroundColor = [UIColor darkGrayColor];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (toolBarTitle) {
        [mainToolbar setTitle:toolBarTitle];
    }
}
...
- (void)dealloc
{
    ...
    [toolBarTitle release],toolBarTitle = nil;
...
- (void)tappedInToolbar:(ReaderMainToolbar *)toolbar thumbsButton:(UIButton *)button
{
    ...
    if (toolBarTitle) {
        ...
        thumbsViewController.toolBarTitle = toolBarTitle;
    }
